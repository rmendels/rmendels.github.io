---
title: "Low-dimensional Representation of Dynamic Systems with Phase-lags"
subtitle: "A Composition in Several Movements"
author: "by Mendelssohn"
date: "`r Sys.Date()`"
output:
...
```{r season_compare1, comment = "#", eval = FALSE }
...
```{r phase_vector, comment='#', eval = FALSE}
...
---
```{r season_shift, comment = "#", eval = FALSE}
...
```{r plot_shift, comment = "#", eval = FALSE}
...
```{r plot_shift_zoom, comment = "#", eval = FALSE}
# Zoom seasonal shift
